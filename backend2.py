...
DB_CONFIG = {
    "host": os.getenv("MYSQL_HOST", "ventas-ia-mysql.mysql.database.azure.com"),
    "user": os.getenv("MYSQL_USER", "wsuarez@ventas-ia-mysql.mysql.database.azure.com"),
    "password": os.getenv("MYSQL_PASSWORD", "Afsmnz78"),
    "database": os.getenv("MYSQL_DATABASE", "ventas_db"),
}

# Configuración de Azure OpenAI
openai.api_type = "azure"
openai.api_base = os.getenv("AZURE_ENDPOINT", "https://ventas-ia-openia.openai.azure.com/")
openai.api_version = "2023-06-01-preview"
openai.api_key = os.getenv("AZURE_OPENAI_KEY", "9kUCQ1ItOwvz5kwf5eSCuG26O9pZGxGuNAVak6jY8MmzRSGv8c4cJQQJ99BBACR0EKYXJ3w3AAABACOGrRQv")
